...
// Nationality names are adjective forms used for nationality dropdowns
...
export const COUNTRIES: Country[] = [
  ...
  { code: 'AG', name: 'Antigua and Barbuda', nationality: 'Antiguans' },
  ...
  { code: 'DJ', name: 'Djibouti', nationality: 'Djibouti' },
...
// Lookup helper: get country by code
export function getCountryByCode(code: string): Country | undefined {
  return COUNTRIES.find(c => c.code === code);
}

// Lookup helper: get nationality by code
export function getNationalityByCode(code: string): string {
  return getCountryByCode(code)?.nationality ?? code;
}
